...
     */
    ...
    public void onOpen(Session session,@PathParam("nickname") String nickname) throws IOException {
    	...
    	//onMessage(message, session1, nickname1);
    	//broadcast("有新连接加入:"+nickname+"(其频道号："+session.getId()+"),当前在线人数为" + webSocketSet.size());
	}
	/**
     * 连接关闭调用的方法
     */
...
//			    	String filePath = root+File.separator+FileName;
				broadcast(nickname+"-!0!-"+socketMsg.getMsg()+"-!0!-"+socketMsg.getimgMsg()+"-!0!-"+socketMsg.getName());
...
     * 
	...
	public void broadcast(String message) throws IOException{
		for (MyWebSocket item : webSocketSet) {
			...
			//System.out.println(replaceAllBlank(message.split(":")[1]).length());
			
			//if (replaceAllBlank(message.split(":")[1]).equals("1")) {
